const Socials = () => {
    return(
        ...
        <div className="text-black mt-[19rem] ml-[1rem]">
              <button className='w-[6rem] h-[2rem] text-[0.6rem] border-2 text-black rounded-2xl mt-4'>Follow Us</button>
        </div>

        <div className="text-gray-600 mt-[20rem] w-[70%] ml-[1rem] flex justify-around">
